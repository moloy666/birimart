<script>
    ...
    function add_to_bag(btn, sale_price, product_id, master_id, vendor_id) {
        ...
        add_product_to_cart(product_qty, product_id, master_id, vendor_id);
    }

    function add_product_to_cart(product_qty, product_id, master_id, vendor_id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url('customer/add_product_to_cart') ?>", // https://www.v-xplore.com/dev/ci_bikrimart/cart_session
            data: {
                "qty": product_qty,
    ...
    function inc(element, sale_price, product_id, master_id, vendor_id) {
    ...
    function dec(element, sale_price, product_id, master_id, vendor_id) {
        let quantity = $('.quantity_' + product_id).val();
        let product_qty = parseInt(quantity) - 1;
        if (product_qty == 0) {
    ...
    function increase(element, sale_price, product_id, master_id, vendor_id) {
    ...
    function decrease(element, sale_price, product_id, master_id, vendor_id) {
        let quantity = $('.mobile_quantity_' + product_id).val();
        let product_qty = parseInt(quantity) - 1;
        if (product_qty == 0) {
